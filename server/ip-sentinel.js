...
const PRIVATE_RANGES = [
  // [起始 IP 的 32 位整数, 掩码位数, 原因 key（前端按 sus.reason.<key> 翻译）]
  [ip2int('198.18.0.0'), 15, 'rfc2544'],
  [ip2int('192.0.2.0'), 24, 'testnet1'],
  [ip2int('192.168.0.0'), 16, 'private'],
  [ip2int('10.0.0.0'), 8, 'private'],
  [ip2int('172.16.0.0'), 12, 'private'],
  [ip2int('127.0.0.0'), 8, 'loopback'],
  [ip2int('0.0.0.0'), 8, 'invalid'],
];
 ...
 * @returns {string|null} 命中则返回原因 key（rfc2544/testnet1/private/loopback/invalid），否则 null
 */
